...
public class Solution {
  ...
  static int getTopicCount(String topic) throws IOException {
    ...
    // Since I can't use Spring, JBoss, JAX-RS, RestEasy or whatever, my first logical choice is to
    // use HttpURLConnection.
    HttpURLConnection connection = (HttpURLConnection) url.openConnection();
    connection.setRequestMethod("GET");

    // We read the JSON response by using getting the above Connection's inputStream, which will
    // return Wikipedia's response for our desired topic.
